            ...
            <Wrapper>
                <Left>
                    ...
                    <Wrap>
                        ...
                        <Line></Line>
                        <Content>For you to become a representative of Pro-TradeAssets.com, you need to have the ability to promote and support our cryptocurrency trading project in your region through various means, like online/offline presentations, meetings with clients, a personal blog, etc. However, notes that we never support SPAM nor any form of illegal promotion of our project. If you think this is ‘right up your alley’, then send your personal details; full name, phone number, username, country, city, email and messenger ID to <a style={{textDecoration: "none"}} href='/about'>Protradeassets@gmail.com</a>, and we will respond within 24 business hours. You don’t need to have an active deposit to be a Regional Representative</Content>
                        <ButtonHold>
