...
function Question() {
  ...
  const allQuestions = [
    ...
    },
    {
      ...
      answer:
        "A: You already made a good decision by deciding to join our community. Pro-TradeAssets.com is a completely risk-free trading company, all thanks to our overall ideology and company concept. In addition, our company is made up of certified professionals in various fields such as cryptocurrency trading, blockchain technology, cryptocurrency finance and security. Our goal is to provide a seamless trading experience based on expert project management. We aim to make cryptocurrency trading available to anybody that has no experience within the field.",
      open: false,
    },
  ];
