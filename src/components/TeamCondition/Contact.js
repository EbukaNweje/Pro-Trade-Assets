    ...
    <div>
      ...
      <section className="maincontainer">
        ...
        <div className="Standard">
            ...
            <p>
            1.1. The terms and conditions outlined in this agreement are comprehensive and should by followed explicitly by all users (hereinafter referred to as "Seller" or "Buyer") of the Pro-TradeAssets.com Ltd (hereinafter referred to as “Company” or Pro-TradeAssets.com’) platform, as well as all other platform features.
            </p>
            <p>
            1.2. To start using the the platform offered by Pro-TradeAssets.com, the Seller is required to fully accept all written statements, their rules and implications stated in this agreement. The Company is not to be held accountable and is not accountable for any breach of terms of this agreement on the part of the Seller.
            </p>
            <p>
        ...
        <div className="Standard">
            ...
            <p>
            2.1. Pro-TradeAssets.com systems are scalable distributed computing systems for the purposes of cryptocurrency trading. The central data hub of the Company is where all the servers are located that power the platform.
            </p>
            <p>
            2.2. The Company gives Buyers the opportunity of receiving measureable capital income through the Pro-TradeAssets.com® platform (http://Pro-TradeAssets.com). Based on the Seller’s use of the platform, all income and capital will be assessed and given.
            </p>
           </div>
        ...
        <div className="Standard">
            ...
            <p>
              3.1. To generate capital with the Pro-TradeAssets.com system, each Seller must have an “Active” account—meaning that there is no less than BTC 0.001 in the Seller’s account.
            </p>
            <p>
            ...
            <p>
            3.5. All withdrawals from the Pro-TradeAssets.com system is done instantly as soon as the Seller requests a withdrawal.
            </p>
           </div>
        <div className="Standard">
            <h5>4. Parties to the Agreement</h5>
            <p> 
               4.1. To become a Seller, all instructions on http://Pro-TradeAssets.com must be completed to open an account.
            </p>
            <p>
            ...
            <p>
              4.4. By opening an account with Pro-TradeAssets.com, each Buyer assures that their use of the platform will not be for illegal purposes.
            </p>
            <p>
        ...
        <div className="Standard">
            ...
            <p> 
              6.1. The Platform Affiliate Program fast-tracks the lead generation of Buyers of Pro-TradeAssets.com.
            </p>
            <p>
               6.2. A 4% affiliate commission fee will be paid by the platform for referrals to Pro-TradeAssets.com by Buyers.
            </p>
            <p>
        ...
        <div className="Standard">
            ...
            <p> 
              7.1. Pro-TradeAssets.com can suspend the platform if technological disasters, world economic crisis, earthquake, wars, revolution, epidemics and strikes threaten or become detriment to platform use.
            </p>
           </div>
        <div className="Standard">
            <h5>Privacy Policy</h5>
            <p> 
            1.1. This Privacy Policy (Policy) covers all information exchanged between Pro-TradeAssets.com® and Buyers and Seller
            </p>
            <p> 
